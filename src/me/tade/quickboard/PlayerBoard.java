...
public class PlayerBoard {
    ...
    public String setHolders(String s) {
        ...
        if (s != null && Bukkit.getPluginManager().isPluginEnabled("PlaceholderAPI") && PlaceholderAPI.containsPlaceholders(s))
    ...
    public static String TranslateHexColorCodes(final char altColorChar, final String textToTranslate) {
